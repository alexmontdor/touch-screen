...
function handleDragStart (event) {
  ...
  console.log(posElement.x, window.offsetLeft, container.offsetLeft)
  posElement.x = window.offsetLeft + container.offsetLeft;
  posElement.y = window.offsetTop + container.offsetTop;
